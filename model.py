...
def get_dlB(inputShape, chN=3, lr = 1e-4, loss='binary_crossentropy', metrics=['accuracy'], modelFile=""):
    """Getting dlB model architecture with predefined input shape   
    ...
    if modelFile!="":
        try:
            model.load_weights(modelFile) #Model B
